...
tf.app.flags.DEFINE_string('data_path', '/datadrive/lstm_codes/textsum/codes/dataset/finished_files/cnn_dm/test.bin', 'Path expression to tf.Example datafiles. Can include wildcards to access multiple datafiles.')
...
tf.app.flags.DEFINE_string('model_dir',
                           'model_decode_1_2', 'Path expression to tf.Example.')
tf.app.flags.DEFINE_string('system_dir',
                           'system_decode_1_2', 'Path expression to tf.Example.')
